...
// Adds a commentary in front of every function (if it is missing)
// Makes sure not to comment on obvious things
func main() {
    gofmt_all()
}

// Formats all files in file_map using gofmt function
func gofmt_all() {
...
// Formats a file using gofmt command
...
// Runs a command and returns output and error
