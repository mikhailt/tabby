// Package main provides the implementation of a text editor.
package main
...
// get_source returns source code from source_buf.
...
// file_stack_push pushes a file name to file stack.
...
// file_stack_pop pops a file name from file stack.
...
// stack_next moves the stack pointer to the next index.
...
// stack_prev moves the stack pointer to the previous index.
...
// mark_set_cb is the callback function for marking the current selection.
func mark_set_cb() {
...
// find_next_instance searches for the next instance of selected text.
...
// next_instance_cb is the callback function for finding the next instance of selected text.
...
// find_prev_instance searches for the previous instance of selected text.
...
// prev_instance_cb is the callback function for finding the previous instance of selected text.
...
// move_focus_and_selection moves the cursor to the new selection.
...
// tree_view_scroll_to_cur_iter scrolls to the current iterator of tree view.
...
// source_selection gets the selected text in the source file.
...
// next_file_cb switches to the next file.
func next_file_cb() {
	if file_stack_top == file_stack_max {
		return
	}
...
// prev_file_cb switch to the previous file.
func prev_file_cb() {
...
// init_navigation initializes navigation related variables.
