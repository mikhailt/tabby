...
// Find all occurrences of a pattern in all files
...
// Callback function for find file button
func find_file_cb() {
    find_common(true)
}

// Common function for find and find file callbacks
