...
// find_global searches for the pattern in all files.
...
// find_cb is called when find button is clicked.
func find_cb() {
    find_common(false)
}

// find_file_cb is called when find file button is clicked.
func find_file_cb() {
    find_common(true)
}

// find_common is the common function which is called by both find_cb and find_file_cb.
...
// find_in_current_file searches for the pattern in current file.
...
// find_dialog opens the find dialog.
