// This package is the main entry point of the Tabby editor.
package main
...
// open_files_from_args will open all the files from tabby_args.
...
// tabby_server is the server function of Tabby editor.
func tabby_server() {
	var focus_line int
	buf := make([]byte, 1024)
...
// provide_tabby_server determines whether a new instance of Tabby editor should be spawned.
...
// init_args initializes the command-line arguments passed to Tabby editor.
func init_args() bool {
...
// pack_tabby_args returns the arguments passed to Tabby editor in a packed format.
...
// simplified_path returns the simplified version of a file path.
...
// prefixed_path returns the file path with a prefix.
...
// open_file_from_args opens a file passed as an argument to Tabby editor.
