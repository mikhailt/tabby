...
// delete_file_record removes a record of a deleted file
...
// add_file_record adds a new record for a new file and returns a bool representing success or failure
