...
// lang_refresh updates the language of the source buffer based on the current file's extension
func lang_refresh() {
...
// lang_get_extension extracts the file extension from the provided name
...
// init_lang initializes the language map and sets the default language to shell
func init_lang() {
