...
// It checks if the language is already set and returns if it is.
func lang_refresh() {
...
// lang_get_extension retrieves the file extension from the given file name.
...
// init_lang initializes the language map with supported file extensions.
// It also sets the default language to sh.
func init_lang() {
