...
// lang_refresh refreshes the language based on the file extension
// and sets the language of the source buffer
func lang_refresh() {
...
// lang_get_extension gets the file extension of the given file name
...
// init_lang initializes the language map with supported languages
// and sets the default language of the source buffer
func init_lang() {
