...
var source_buf *gtksourceview.GtkSourceBuffer
var source_view *gtksourceview.GtkSourceView
...
func init_tabby() {
	...
	source_view = gtksourceview.SourceViewWithBuffer(source_buf)
	...
	source_view.SetDrawSpaces(gtksourceview.GTK_SOURCE_DRAW_SPACES_TAB)
	source_view.SetSmartHomeEnd(gtksourceview.GTK_SOURCE_SMART_HOME_END_ALWAYS)
	...
	new_item.AddAccelerator("activate", accel_group, gdk.GDK_KEY_n, gdk.GDK_CONTROL_MASK, gtk.GTK_ACCEL_VISIBLE)

	open_item := gtk.MenuItemWithMnemonic("_Open")
	file_submenu.Append(open_item)
	open_item.Connect("activate", open_cb, nil)
	open_item.AddAccelerator("activate", accel_group, gdk.GDK_KEY_o, gdk.GDK_CONTROL_MASK, gtk.GTK_ACCEL_VISIBLE)
	...
	save_item.AddAccelerator("activate", accel_group, gdk.GDK_KEY_s, gdk.GDK_CONTROL_MASK, gtk.GTK_ACCEL_VISIBLE)
	...
	close_item.AddAccelerator("activate", accel_group, gdk.GDK_KEY_w, gdk.GDK_CONTROL_MASK, gtk.GTK_ACCEL_VISIBLE)
	...
	find_item.AddAccelerator("activate", accel_group, gdk.GDK_KEY_f, gdk.GDK_CONTROL_MASK, gtk.GTK_ACCEL_VISIBLE)
	...
	find_file_item.AddAccelerator("activate", accel_group, gdk.GDK_KEY_d, gdk.GDK_CONTROL_MASK, gtk.GTK_ACCEL_VISIBLE)

	fnr_item := gtk.MenuItemWithMnemonic("Find and Replace")
	navigation_submenu.Append(fnr_item)
	fnr_item.Connect("activate", fnr_cb, nil)
	fnr_item.AddAccelerator("activate", accel_group, gdk.GDK_KEY_r, gdk.GDK_CONTROL_MASK, gtk.GTK_ACCEL_VISIBLE)
	...
	gofmtAll_item.AddAccelerator("activate", accel_group, gdk.GDK_KEY_F9, gdk.GDK_CONTROL_MASK, gtk.GTK_ACCEL_VISIBLE)
