// Package main provides a text editor called Tabby.
package main
...
// Refresh the title of current Tabby window.
func refresh_title() {
	if "" == cur_file {
...
// Callback function for buffer change.
func buf_changed_cb() {
	refresh_title()
}

// Show notification dialog with the message m.
