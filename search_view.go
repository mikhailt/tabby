...
// Select selects the current item in the tree view
...
// SetCursor sets the cursor position in the tree view
...
// AddFile adds a file to the search view tree
...
// NextResult selects the next result in the tree view
...
// PrevResult selects the previous result in the tree view
...
// PrepareToSearch prepares the search view for a search
